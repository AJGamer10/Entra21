...
class DamageCalculator(ABC):
    ...
    @abstractmethod
    def calcular_dano(self, atacante_ataque: int, atacante_tipos: List[str], ataque_dano: int, ataque_tipo: str, oponente_tipos: List[str], oponente_defesa: int) -> int:
        ...
        efetividades = [self.__verificar_efetividade(tipo_ataque, tipo_oponente) for tipo_oponente in oponente_tipos]
