...
class Pokemon:
    ...
    def atacar(self, atacante: Pokemon, ataque: Attack, oponente: Pokemon) -> None:
        dano = DamageCalculator.calcular_dano(DamageCalculator, atacante.ataque, atacante.tipos, ataque.dano, ataque.tipo, oponente.tipos, oponente.defesa)
